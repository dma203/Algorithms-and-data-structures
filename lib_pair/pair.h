...
public:
    ...
    friend TPair& operator-(const TPair<T1, T2>& pair1,
...
template <class T1, class T2>
TPair<T1, T2>& TPair<T1, T2>::operator=(const TPair<T1,
    T2>& pair) noexcept {
    if (this != &pair) {
        _first = pair._first;
...
template <class T1, class T2>
TPair<T1, T2>& operator-(const TPair<T1, T2>& pair1,
    const TPair<T1, T2>& pair2) noexcept {
    TPair<T1, T2> temp(*this);
    temp._first -= pair._first;
    temp._second -= pair._second;
